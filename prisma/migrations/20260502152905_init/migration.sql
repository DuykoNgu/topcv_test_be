...
-- AddForeignKey
ALTER TABLE "submission_values" ADD CONSTRAINT "submission_values_field_id_fkey" FOREIGN KEY ("field_id") REFERENCES "fields"("id") ON DELETE CASCADE ON UPDATE CASCADE;
